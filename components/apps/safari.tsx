  ...
  const HomeView = () => (
    <div className="relative h-full overflow-y-auto">
      <div className="fixed-bg absolute inset-0 -z-0">
        <img src="/image.jpg" alt="Safari start page background" className="h-full w-full object-cover sticky top-0" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.12),transparent_32%),linear-gradient(180deg,rgba(4,10,24,0.18),rgba(4,10,24,0.72))]" />
      </div>

      <div className="relative z-10 px-5 pb-16 pt-8 sm:px-8">
        <div className="mx-auto w-full max-w-3xl">
          {/* About Me Hero */}
          <div className="mb-10 text-center">
            <img src="/letter-s.png" alt="Sreeshanth Soma" className="w-16 h-16 rounded-full mx-auto mb-4 ring-2 ring-white/20 shadow-lg" />
            <h1 className="text-2xl sm:text-3xl font-bold text-white drop-shadow-lg">
              Sreeshanth Soma
            </h1>
            <div className="flex items-center justify-center gap-3 mt-5">
              <a href="https://github.com/sreeshanth-soma" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white text-sm px-5 py-2.5 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/20 transition-all">
              ...
              <a href="https://linkedin.com/in/sreeshanth-soma" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white text-sm px-5 py-2.5 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/20 transition-all">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                LinkedIn
              </a>
              <a href="mailto:sreeshanthsoma@gmail.com" className="flex items-center gap-2 text-white text-sm px-5 py-2.5 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/20 transition-all">
          ...
          {/* Favorites Grid */}
          <div className="mb-4">
            <h2 className="text-white/40 text-[11px] font-semibold uppercase tracking-wider mb-4 px-1">Favorites</h2>
          </div>
