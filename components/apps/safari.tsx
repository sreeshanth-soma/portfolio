...
export default function Safari({ isDarkMode = true }: SafariProps) {
  const [url, setUrl] = useState("https://sreeshanthsoma.dev")
  ...
  const socialLinks = [
    {
      title: "LinkedIn",
      url: "https://www.linkedin.com/in/sreeshanth-soma/",
      icon: "/linkedin.png",
    },
    {
      title: "GitHub",
      url: "https://github.com/sreeshanth-soma",
      icon: "/github.png",
    },
    {
      title: "Email",
      url: "mailto:mail@sreeshanthsoma",
      icon: "/mail.png",
    },
  ]
            ...
            <div className="p-8">
              ...
              <div className="mt-8 max-w-2xl mx-auto">
                <div className={`p-6 rounded-lg ${cardBg}`}>
                  <h3 className="text-xl font-semibold mb-4">Sreeshanth Soma - Portfolio</h3>
                  <p className="mb-4">
