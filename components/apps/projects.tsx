...
const projects = [
  {
    ...
    description: "Interactive macOS-style portfolio website with window management, dock, Liquid Glass UI, and multiple apps.",
  ...
  },
  {
    id: 2,
    name: "Project 2",
    description: "Add your project description here. What problem does it solve? What technologies did you use?",
    tech: ["React", "Node.js"],
    url: "",
    github: "",
    icon: "🚀",
